...
public class UserController {
    ...
    public Object getMypage(@ApiParam(value = "user_id", required = true, example = "12345")
    ...
    public Object changeBadge(@RequestParam(value = "user_id", required = true) String id,
                              @RequestParam(value = "badge", required = true) int badge) {
    ...
    public Object changeProfileImg(@RequestParam(value = "user_id", required = true) String id,
                                   @RequestParam(value = "badge", required = true) int profile_img) {
    ...
    public Object changeNickname(@RequestParam(value = "user_id", required = true) String id,
                                 @RequestParam(value = "badge", required = true) String mode){
