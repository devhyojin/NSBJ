...
public class UserController {
    ...
    public Object changeBadge(@RequestParam(value = "user_id", required = true) Long id,
    ...
    public Object changeProfileImg(@RequestParam(value = "user_id", required = true) Long id,
    ...
    public Object changeNickname(@RequestParam(value = "user_id", required = true) Long id,
