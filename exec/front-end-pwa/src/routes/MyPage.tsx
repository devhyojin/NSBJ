...
import ModalConfirm from '../components/My/ModalConfirm';
import ModalBadgeInfo from '../components/My/ModalBadgeInfo';
import ModalCharacter from '../components/My/ModalCharacter';
